...
export function corsMiddleware(req: Request, res: Response, next: NextFunction) {
  ...
  res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, Origin, Accept, X-Requested-With, Cache-Control, X-Forwarded-For, X-Real-IP, X-Forwarded-Proto');
